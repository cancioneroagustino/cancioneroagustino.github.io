...
Cambios Realizados:
Expresiones Regulares Actualizadas: Las expresiones regulares chordRegex y chordReplaceRegex se han actualizado para incluir los acordes en notación latina (DO, RE, MI, FA, SOL, LA, SI) con los modificadores correspondientes.
Lógica de Identificación de Acordes: La función wrapChords utiliza chordReplaceRegex para identificar los acordes y envolverlos en un <span> con la clase c, lo que permite aplicar la transposición solo a esos elementos.
Ahora, el script debería funcionar correctamente con la notación latina y tratar cualquier línea que contenga estos acordes en mayúscula como una línea de acorde.

genial! muchas gracias! 

ahora me gustaría que al principio se agregase un botón que diga "Sólo texto" y que pueda activar y desactivar.  Que cuando lo active, se borren todas las líneas de acordes, quedando sólo la letra de las canciones. Y que éstas vuelvan cuando vuelva a apretar el botón
Para agregar la funcionalidad de un botón que permita alternar entre mostrar sólo el texto de las canciones y mostrar las líneas de acordes, podemos seguir estos pasos:

Agregar el botón al inicio del contenido.
Implementar la funcionalidad de ocultar y mostrar las líneas de acordes cuando se haga clic en el botón.
Aquí tienes el código actualizado para cancionero.js con los cambios necesarios:
